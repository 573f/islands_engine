defmodule IslandsEngine.Rules do
  @moduledoc """
  Enforces the Rules via a state machine. Valid states are:
  - :initialized
  - :players_set
  - :player1_turn
  - :player2_turn
  ...
  @doc """
  Checks if the supplied action is valid for the current state, and if so,
  applies the appropriate state change.
  """
